...
class SqliteNovelRepository(NovelRepository):
    ...
    def save(self, novel: Novel) -> None:
        ...
        sql = """
            INSERT INTO novels (
                ...
                autopilot_status, auto_approve_mode, autopilot_mode, current_stage, current_act, current_chapter_in_act,
    ...
    def _row_to_novel(self, novel_id: NovelId, row: dict) -> Novel:
        ...
        return Novel(
            ...
            autopilot_mode=row.get('autopilot_mode', 'full_draft') or 'full_draft',
